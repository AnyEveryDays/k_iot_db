...
-- insert into `users`
-- values
-- 	(2, 'qwe12','qwe12312','qwe123@example.com','1234567');
# Error Code: 1062. Duplicate entry 'qwe123@example.com' for key 'users.email'

insert into `users`
values
	(2, 'wer123','wer234234',null,'654321');
    -- unique는 null값 삽입 가능!
...
/*
    ...
    - 선택적 필드에 대한 입력을 단순화 (데이터 무결성을 유지)
*/    
...
values
    ...
    -- null값 입력 시 null 값 지정 가능(기본값 설정 X)
